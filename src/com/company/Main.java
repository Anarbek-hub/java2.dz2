...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Category objectA = new Category(Color.BLACK, fuel, "Седан", 120);
        ...
        Brand objectB = new Brand(Color.RED, fuel1, "Кабриолет",
                1000, "BMW", 6, 2010, 1000);
        ...
        Brand objectC = new Brand(Color.WHITE, fuel2, "Хетчбэк", 1400,
                "Tesla", 0, 2015, 1000);
